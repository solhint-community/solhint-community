...
| [no-comparison-in-expression](./rules/best-practises/no-comparison-in-expression.md) | Disallows comparisons used as standalone expression statements (i.e. no assigned result).                                                  |             |
