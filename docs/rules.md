...
| [non-state-vars-leading-underscore](./rules/naming/non-state-vars-leading-underscore.md) | Variables that are not in the state should start with underscore. Example: `_myVar`.   |             |
